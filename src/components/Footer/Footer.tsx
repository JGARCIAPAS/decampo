...
const Footer = () => {
  return (
    <>
      <div className="bg-footer_light_gray border-t border-gray-300">
        <div className="py-5 w-9/12 mx-auto grid grid-cols-2">
          ...
          <div className="text-right">
            <span className="inline-block mr-2.5 font-sanablackregular">
              Apps gratuitas
            </span>
            <img
      ...
      <div className="bg-cookie_gray">
        <div className="w-9/12 mx-auto ">
          <div className="grid grid-cols-5 border-b border-gray-500 pt-5 pb-4">
            <div>
              ...
              <ul className="block">
                <li className="text-white font-sanamedium text-sm">
                  Decampo Ciudad Meseta
                </li>
                <li className="text-white font-sanamedium text-sm">
                  00 000 00 00
                </li>
          ...
          <div className="grid grid-cols-5 border-b border-gray-500 pb-7 pt-7">
            <div>
              ...
              <ul className="block">
                ...
                <li className="text-white font-sanamedium text-sm">Horarios</li>
                <li className="text-white font-sanamedium text-sm">
                  Métodos de pago
                </li>
                <li className="text-white font-sanamedium text-sm">
        ...
        <div className="text-center py-5 text-sm">
          <a className="text-white font-sanamedium px-6">Aviso legal</a>
          <a className="text-white font-sanamedium px-6">Política de cookies</a>
          <a className="text-white font-sanamedium px-6">
            Condiciones generales de venta
          </a>
          <a className="text-white font-sanamedium px-6">
            Politica de privacidad
          </a>
          <a className="text-gray-500 block font-sanamedium py-4 block">
